    ...
    public String execute(AgentDefinition rootAgent, String initialInput, List<Media> media,
        ...
        for (PlannedStep step : plan.steps()) {
            ...
            try {
                ...
                String teamRunId = com.operativus.agentmanager.core.callback.AgentContextHolder.getCurrentRunId();
                java.util.Map<String, Object> cursor = new java.util.HashMap<>();
                cursor.put(com.operativus.agentmanager.core.model.TeamMemberDispatchExtraOptions.STRATEGY, "PLANNER");
                cursor.put(com.operativus.agentmanager.core.model.TeamMemberDispatchExtraOptions.CURRENT_INPUT, stepInput == null ? "" : stepInput);
                cursor.put(com.operativus.agentmanager.core.model.TeamMemberDispatchExtraOptions.SESSION_ID, sessionId == null ? "" : sessionId);
                cursor.put(com.operativus.agentmanager.core.model.TeamMemberDispatchExtraOptions.USER_ID, userId == null ? "" : userId);
                cursor.put(com.operativus.agentmanager.core.model.TeamMemberDispatchExtraOptions.MEMBER_INDEX, step.stepNumber());
                cursor.put(com.operativus.agentmanager.core.model.TeamMemberDispatchExtraOptions.PLAN, encodePlan(plan));
    ...
    public String resumeAt(AgentDefinition rootAgent, ExecutionPlan plan, int fromStepNumber,
        ...
        for (PlannedStep step : plan.steps()) {
            ...
            try {
                ...
                java.util.Map<String, Object> cursor = new java.util.HashMap<>();
                cursor.put(com.operativus.agentmanager.core.model.TeamMemberDispatchExtraOptions.STRATEGY, "PLANNER");
                cursor.put(com.operativus.agentmanager.core.model.TeamMemberDispatchExtraOptions.CURRENT_INPUT, stepInput);
                cursor.put(com.operativus.agentmanager.core.model.TeamMemberDispatchExtraOptions.SESSION_ID, sessionId == null ? "" : sessionId);
                cursor.put(com.operativus.agentmanager.core.model.TeamMemberDispatchExtraOptions.USER_ID, userId == null ? "" : userId);
                cursor.put(com.operativus.agentmanager.core.model.TeamMemberDispatchExtraOptions.MEMBER_INDEX, step.stepNumber());
                cursor.put(com.operativus.agentmanager.core.model.TeamMemberDispatchExtraOptions.PLAN, encodePlan(plan));
