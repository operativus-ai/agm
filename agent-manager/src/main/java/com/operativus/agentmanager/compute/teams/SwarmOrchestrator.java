...
public non-sealed class SwarmOrchestrator implements OrchestrationStrategy {
    ...
    private final com.operativus.agentmanager.compute.service.AgentClientFactory agentClientFactory;
    ...
    private final com.operativus.agentmanager.compute.memory.EphemeralSwarmContext ephemeralSwarmContext;
    private final org.springframework.context.ApplicationEventPublisher eventPublisher;
    private final com.operativus.agentmanager.core.event.AgentRunEventBus eventBus;
    ...
    public SwarmOrchestrator(org.springframework.ai.chat.client.ChatClient.Builder builder,
                             ...
                             com.operativus.agentmanager.compute.memory.EphemeralSwarmContext ephemeralSwarmContext,
                             org.springframework.context.ApplicationEventPublisher eventPublisher,
                             com.operativus.agentmanager.core.event.AgentRunEventBus eventBus,
                             com.operativus.agentmanager.compute.service.AgentClientFactory agentClientFactory,
    ...
    public String execute(AgentDefinition rootAgent, String initialInput, List<Media> media, String sessionId, String userId, String orgId, Boolean generateFollowups, AgentOperations runner) {
        ...
        if (members.isEmpty()) {
            throw new com.operativus.agentmanager.core.exception.BusinessValidationException("Swarm failed: No valid, active members found.");
        }
        ...
        final String parentRunId = com.operativus.agentmanager.core.callback.AgentContextHolder.getCurrentRunId();
        final String parentUserId = com.operativus.agentmanager.core.callback.AgentContextHolder.getUserId();
        final String parentOrgId = com.operativus.agentmanager.core.callback.AgentContextHolder.getOrgId();
        final String parentSessionId = com.operativus.agentmanager.core.callback.AgentContextHolder.getSessionId();
        final Integer parentDepth = com.operativus.agentmanager.core.callback.AgentContextHolder.getOrchestrationDepth();
        ...
        final java.util.Set<String> parentApprovedToolsSnapshot =
                com.operativus.agentmanager.core.callback.AgentContextHolder.approvedTools.isBound()
                        ? java.util.Set.copyOf(com.operativus.agentmanager.core.callback.AgentContextHolder.approvedTools.get())
                        : null;
        ...
        try (var executor = java.util.concurrent.Executors.newVirtualThreadPerTaskExecutor()) {
            ...
            for (SwarmSubtask subtask : orchestratorResponse.subtasks()) {
                 ...
                 eventPublisher.publishEvent(new com.operativus.agentmanager.core.event.AgentSwitchEvent(
                 ...
                 scopeTasks.add(executor.submit(io.micrometer.context.ContextSnapshotFactory.builder().build().captureAll().wrap(() -> {
                     ScopedValue.Carrier carrier = ScopedValue
                         .where(com.operativus.agentmanager.core.callback.AgentContextHolder.currentRunId, parentRunId)
                         .where(com.operativus.agentmanager.core.callback.AgentContextHolder.userId, parentUserId)
                         .where(com.operativus.agentmanager.core.callback.AgentContextHolder.orgId, parentOrgId)
                         .where(com.operativus.agentmanager.core.callback.AgentContextHolder.sessionId, parentSessionId)
                         .where(com.operativus.agentmanager.core.callback.AgentContextHolder.orchestrationDepth, parentDepth != null ? parentDepth : 0)
                         .where(com.operativus.agentmanager.core.callback.AgentContextHolder.telemetry, new com.operativus.agentmanager.core.callback.RunTelemetryAccumulator());
                     if (memberApprovedTools != null) {
                         carrier = carrier.where(com.operativus.agentmanager.core.callback.AgentContextHolder.approvedTools, memberApprovedTools);
                     }
                     return carrier.call(() -> {
                             com.operativus.agentmanager.core.callback.AgentContextHolder.populateMdcFromScopedValues();
                             try {
                                 ...
                                 humanReviewGate.requireApprovalIfConfigured(
                                         ...
                                         java.util.Map.of(
                                                 com.operativus.agentmanager.core.model.TeamMemberDispatchExtraOptions.STRATEGY, "SWARM",
                                                 com.operativus.agentmanager.core.model.TeamMemberDispatchExtraOptions.CURRENT_INPUT,
                                                         currentSubtask.specificQuery() == null ? "" : currentSubtask.specificQuery(),
                                                 com.operativus.agentmanager.core.model.TeamMemberDispatchExtraOptions.SESSION_ID,
                                                         sessionId == null ? "" : sessionId,
                                                 com.operativus.agentmanager.core.model.TeamMemberDispatchExtraOptions.USER_ID,
                                                         userId == null ? "" : userId));
                                 ...
                                 com.operativus.agentmanager.core.callback.AgentContextHolder.clearMdcFromScopedValues();
                             }
                         });
                 })));
            }
            ...
            for (int i = 0; i < scopeTasks.size(); i++) {
                ...
                try {
                    ...
                    if (cause instanceof com.operativus.agentmanager.core.exception.TeamMemberPausedException tpe) {
    ...
    private void publishDecisionEvent(java.util.Map<String, Object> payload) {
        ...
        String runId = com.operativus.agentmanager.core.callback.AgentContextHolder.getCurrentRunId();
        if (runId == null) return;
        try {
            com.operativus.agentmanager.core.event.AgentRunEvent event = new com.operativus.agentmanager.core.event.AgentRunEvent(
                    com.operativus.agentmanager.core.event.AgentRunEventType.ORCHESTRATOR_DECISION,
                    runId,
                    com.operativus.agentmanager.core.callback.AgentContextHolder.getAgentId(),
                    null,
                    com.operativus.agentmanager.core.callback.AgentContextHolder.getSessionId(),
                    com.operativus.agentmanager.core.callback.AgentContextHolder.getOrgId(),
                    com.operativus.agentmanager.core.callback.AgentContextHolder.getOrchestrationDepth(),
                    payload,
