...
public non-sealed class RouterOrchestrator implements OrchestrationStrategy {
    ...
    public String execute(AgentDefinition rootAgent, String initialInput, List<Media> media, String sessionId, String userId, String orgId, Boolean generateFollowups, AgentOperations runner) {
        ...
        eventPublisher.publishEvent(new com.operativus.agentmanager.core.event.AgentSwitchEvent(
                this,
                com.operativus.agentmanager.core.callback.AgentContextHolder.getCurrentRunId(),
        ...
        humanReviewGate.requireApprovalIfConfigured(
                ...
                java.util.Map.of(
                        com.operativus.agentmanager.core.model.TeamMemberDispatchExtraOptions.STRATEGY, "ROUTER",
    ...
    private String determineTargetAgent(AgentDefinition rootAgent, String initialInput, AgentOperations runner, String orgId, String userId) {
        ...
        if (members.isEmpty()) {
            throw new com.operativus.agentmanager.core.exception.BusinessValidationException("Router failed: No valid, active members found for routing.");
        }

        String agentDescriptions = com.operativus.agentmanager.compute.routing.AgentSelectorPromptTemplate
