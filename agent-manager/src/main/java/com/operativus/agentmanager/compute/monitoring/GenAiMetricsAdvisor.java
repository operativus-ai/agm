...
import com.operativus.agentmanager.control.finops.model.FinOpsRecords.ChargebackTag;
...
public class GenAiMetricsAdvisor implements CallAdvisor, StreamAdvisor {
    ...
    private ChargebackTag resolveChargebackTag() {
        var ctx = com.operativus.agentmanager.core.callback.AgentContextHolder.class;
        String orgUnit    = safeGet(() -> com.operativus.agentmanager.core.callback.AgentContextHolder.getOrgId(), "unknown-org");
        String sessionId  = safeGet(() -> com.operativus.agentmanager.core.callback.AgentContextHolder.getSessionId(), "unknown-session");
    ...
    private String resolveAgentId() {
        ...
        return safeGet(() -> com.operativus.agentmanager.core.callback.AgentContextHolder.getAgentId(), "UNKNOWN_AGENT");
    }
