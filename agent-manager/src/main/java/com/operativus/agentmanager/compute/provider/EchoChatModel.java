...
public final class EchoChatModel implements ChatModel {
     ...
     * {@link com.operativus.agentmanager.core.callback.AgentContextHolder} (and mirrored to MDC),
     * so we read it here to attribute each echo to the agent that produced it.
     */
    private String currentLabel() {
        String name = com.operativus.agentmanager.core.callback.AgentContextHolder.getAgentName();
