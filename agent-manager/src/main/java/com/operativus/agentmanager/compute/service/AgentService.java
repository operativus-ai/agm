...
import com.operativus.agentmanager.core.model.RequiredActionType;
import com.operativus.agentmanager.core.model.AgentConstants;
...
public class AgentService implements AgentOperations {
    ...
    private final com.operativus.agentmanager.control.repository.SessionRepository sessionRepository;
    ...
    private final com.operativus.agentmanager.compute.security.ModelRateLimitGuard modelRateLimitGuard;
    private final com.fasterxml.jackson.databind.ObjectMapper objectMapper;
    private final com.operativus.agentmanager.control.finops.service.BudgetPolicyService budgetPolicyService;
    private final com.operativus.agentmanager.control.finops.service.DailySpendService dailySpendService;
    ...
    public AgentService(AgentRegistry agentRegistry,
                        ...
                        com.operativus.agentmanager.control.repository.SessionRepository sessionRepository,
                        Tracer tracer,
                        ...
                        com.operativus.agentmanager.compute.security.ModelRateLimitGuard modelRateLimitGuard,
                        com.fasterxml.jackson.databind.ObjectMapper objectMapper,
                        com.operativus.agentmanager.control.finops.service.BudgetPolicyService budgetPolicyService,
                        com.operativus.agentmanager.control.finops.service.DailySpendService dailySpendService,
    ...
    public RunResponse run(String agentId, String userInput, List<org.springframework.ai.content.Media> media, String sessionId, String userId, String orgId, Boolean generateFollowups, RunOptions options) {
        ...
        try (Tracer.SpanInScope ws = tracer.withSpan(span)) {
            ...
            if (def.isTeam()) {
                if ("COORDINATOR".equalsIgnoreCase(def.teamMode())
                    ...
                    try {
                        ...
                        return teamResp;
                    } catch (com.operativus.agentmanager.core.exception.TeamMemberPausedException tpe) {
                    ...
                    } catch (com.operativus.agentmanager.core.exception.SwarmEscalationException se) {
                    ...
                    } catch (com.operativus.agentmanager.core.exception.ApprovalRequiredException are) {
            ...
            ScopedValue.Carrier runScope = ScopedValue.where(AgentContextHolder.toolTraces, Collections.synchronizedList(new ArrayList<ToolCallDTO>()))
                ...
                .where(AgentContextHolder.requiresEncryption, def.complianceTier() == com.operativus.agentmanager.core.entity.ComplianceTier.TIER_2_STRICT)
            ...
            if (budgetCeiling.isPresent()) {
                runScope = runScope.where(
                    com.operativus.agentmanager.control.security.AgentContextHolder.CONTEXT,
            ...
            RunResponse responseObj = runScope.call(() -> {
                    ...
                    } catch (com.operativus.agentmanager.core.exception.SwarmHandOffException e) {
                    ...
                    } catch (com.operativus.agentmanager.core.exception.ApprovalRequiredException e) {
                        String currentTraceId = span != null ? span.context().traceId() : AgentConstants.NO_TRACE;
                        StringBuilder lineageBuilder = new StringBuilder();
                        AgentContextHolder.getTraces().forEach(t -> lineageBuilder.append(t.toolName()).append(" -> "));
                        String reasoningLineage = lineageBuilder.isEmpty() ? "Direct Execution" : lineageBuilder.toString();
    ...
    private RunResponse finalizeTeamPaused(String executionRunId, String agentId, AgentRun runRecord,
                                           ...
                                           com.operativus.agentmanager.core.model.RequiredAction requiredAction,
                                           String pauseMessage) {
        Map<String, Object> metadata = new java.util.HashMap<>();
    ...
    private com.operativus.agentmanager.core.model.RequiredAction escalationToTeamPause(
            com.operativus.agentmanager.core.exception.SwarmEscalationException e, Span span) {
        String currentTraceId = (span != null && span.context() != null) ? span.context().traceId() : AgentConstants.NO_TRACE;
        return com.operativus.agentmanager.core.model.RequiredAction.swarmEscalation(
                e.getSourceAgentId(),
                e.getTargetAgentId(),
                e.getSourceTier(),
                e.getTargetTier(),
    ...
    private void rejectIfTeamPause(AgentRun run) {
        ...
        com.operativus.agentmanager.core.model.RequiredAction parsed = null;
        String pausedChildRunId = null;
        if (reqAction != null && !reqAction.isBlank()) {
            try {
                parsed = objectMapper.readValue(reqAction, com.operativus.agentmanager.core.model.RequiredAction.class);
                if (parsed != null) {
     ...
     */
    private static String describeChildResumeEndpoint(com.operativus.agentmanager.core.model.RequiredAction parsed) {
    ...
    private com.operativus.agentmanager.core.model.RequiredAction approvalToTeamPause(
            com.operativus.agentmanager.core.exception.ApprovalRequiredException e, Span span) {
        String currentTraceId = (span != null && span.context() != null) ? span.context().traceId() : AgentConstants.NO_TRACE;
        return com.operativus.agentmanager.core.model.RequiredAction.toolApproval(
                e.getToolName(),
                e.getToolArgs(),
                e.getApprovalId(),
                currentTraceId,
    ...
    public Flux<AgentStreamEvent> stream(String agentId, String userInput, List<org.springframework.ai.content.Media> media, String sessionId, String userId, String orgId, Boolean generateFollowups, RunOptions options) {
        ...
        catch (com.operativus.agentmanager.core.exception.RateLimitExceededException ex) { return Flux.error(ex); }
        ...
        AgentStreamManager.StreamScopeBindings bindings = new AgentStreamManager.StreamScopeBindings(
                ...
                def.complianceTier() == com.operativus.agentmanager.core.entity.ComplianceTier.TIER_2_STRICT
        );
    ...
    private void ensureSessionExists(String sessionId, String agentId, String userId, String orgId) {
        String resolvedUser = userId != null ? userId : com.operativus.agentmanager.control.config.SecurityContextUtils.resolveCurrentUserId();
        String resolvedOrg = orgId != null && !orgId.isBlank() ? orgId : com.operativus.agentmanager.core.model.TenantConstants.DEFAULT_SYSTEM_ORG;
