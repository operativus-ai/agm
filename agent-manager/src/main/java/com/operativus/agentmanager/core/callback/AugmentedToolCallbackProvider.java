...
public class AugmentedToolCallbackProvider {
    ...
    private final com.operativus.agentmanager.compute.service.ToolCompressionService compressionService;
    private final AgentRunEventBus eventBus;
    private final boolean toolContentLoggingEnabled;
    private final com.operativus.agentmanager.compute.advisor.HitlAdvisor hitlAdvisor;

    public AugmentedToolCallbackProvider(com.operativus.agentmanager.compute.service.ToolCompressionService compressionService,
                                          AgentRunEventBus eventBus,
                                          @Value("${agentmanager.logging.tool-content:false}") boolean toolContentLoggingEnabled,
                                          com.operativus.agentmanager.compute.advisor.HitlAdvisor hitlAdvisor) {
    ...
    public List<ToolCallback> wrap(List<ToolCallback> originals, com.operativus.agentmanager.core.model.definitions.AgentDefinition agentDef) {
    ...
    private static class TracingToolCallback implements ToolCallback {
        ...
        private final com.operativus.agentmanager.compute.service.ToolCompressionService compressor;
        private final AgentRunEventBus eventBus;
        private final com.operativus.agentmanager.core.model.definitions.AgentDefinition agentDef;
        private final boolean toolContentLoggingEnabled;
        private final com.operativus.agentmanager.compute.advisor.HitlAdvisor hitlAdvisor;

        public TracingToolCallback(ToolCallback delegate,
                                    com.operativus.agentmanager.compute.service.ToolCompressionService compressor,
                                    AgentRunEventBus eventBus,
                                    com.operativus.agentmanager.core.model.definitions.AgentDefinition agentDef,
