package com.operativus.agentmanager.core.model.definitions;
...
public record AgentDefinition(
    ...
    com.operativus.agentmanager.core.entity.FinOpsRiskTier finOpsRiskTier,
    Integer securityTier,
    com.operativus.agentmanager.core.entity.ComplianceTier complianceTier,
     ...
     *  resolve per-member overrides via {@link #withHumanReview(com.operativus.agentmanager.core.model.HumanReview)}.
     *  Null means no review is required — orchestrators must treat null as a no-op gate. */
    com.operativus.agentmanager.core.model.HumanReview humanReview,
    ...
    public AgentDefinition withHumanReview(com.operativus.agentmanager.core.model.HumanReview newHumanReview) {
