...
public class GlobalExceptionHandler {
    ...
    /**
     * Maps {@link com.operativus.agentmanager.control.finops.exception.FinOpsBudgetExhaustedException}
     ...
     */
    @ExceptionHandler(com.operativus.agentmanager.control.finops.exception.FinOpsBudgetExhaustedException.class)
    public ResponseEntity<ProblemDetail> handleFinOpsBudgetExhausted(
            com.operativus.agentmanager.control.finops.exception.FinOpsBudgetExhaustedException ex) {
    ...
    /**
     * Maps {@link com.operativus.agentmanager.control.finops.exception.DailyBudgetExceededException}
     ...
     */
    @ExceptionHandler(com.operativus.agentmanager.control.finops.exception.DailyBudgetExceededException.class)
    public ResponseEntity<ProblemDetail> handleDailyBudgetExceeded(
            com.operativus.agentmanager.control.finops.exception.DailyBudgetExceededException ex) {
