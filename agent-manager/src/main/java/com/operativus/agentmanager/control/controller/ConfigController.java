...
import com.operativus.agentmanager.core.model.TeamTemplate;
import com.operativus.agentmanager.core.model.WorkflowTemplate;
...
public class ConfigController {
    ...
    private final com.operativus.agentmanager.control.service.KnowledgeService knowledgeService;
    private final com.operativus.agentmanager.core.registry.TeamOperations teamOperations;
    private final com.operativus.agentmanager.control.service.WorkflowService workflowService;
    private final String osId = UUID.randomUUID().toString();
    private final String appVersion;

    public ConfigController(AgentRegistry agentRegistry,
                           com.operativus.agentmanager.control.service.KnowledgeService knowledgeService,
                           com.operativus.agentmanager.core.registry.TeamOperations teamOperations,
                           com.operativus.agentmanager.control.service.WorkflowService workflowService,
