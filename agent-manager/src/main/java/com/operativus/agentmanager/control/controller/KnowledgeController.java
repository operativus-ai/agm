...
import com.operativus.agentmanager.control.service.IngestionStatusService;
...
public class KnowledgeController {
    ...
    public ResponseEntity<com.operativus.agentmanager.control.controller.model.UploadBatchResponse> uploadBatch(
        ...
        for (MultipartFile file : files) {
            ...
            } catch (com.operativus.agentmanager.core.exception.BusinessValidationException e) {
        ...
        return ResponseEntity.accepted().body(new com.operativus.agentmanager.control.controller.model.UploadBatchResponse(accepted, rejected));
    }
    ...
    public ResponseEntity<java.util.Map<String, String>> retryIngestion(@PathVariable UUID id) {
        ...
        } catch (com.operativus.agentmanager.core.exception.BusinessValidationException notFailed) {
    ...
    public ResponseEntity<Void> move(
            ...
            @RequestBody com.operativus.agentmanager.control.controller.model.MoveDocumentRequest request) {
