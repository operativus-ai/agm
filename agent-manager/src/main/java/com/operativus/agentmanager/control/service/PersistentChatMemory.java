...
public class PersistentChatMemory implements ChatMemory {
    ...
    private final com.operativus.agentmanager.compute.service.SessionSummarizationService summarizationService;

    public PersistentChatMemory(MessageRepository messageRepository, SessionRepository sessionRepository, com.operativus.agentmanager.compute.service.SessionSummarizationService summarizationService) {
    ...
    private void ensureSessionExists(String sessionId) {
        boolean encryptionRequired = com.operativus.agentmanager.core.callback.AgentContextHolder.getRequiresEncryption();
        String currentAgentId = com.operativus.agentmanager.core.callback.AgentContextHolder.getAgentId();
        sessionRepository.findById(sessionId).ifPresentOrElse(
                ...
                () -> {
                    ...
                    String userId = com.operativus.agentmanager.control.config.SecurityContextUtils.resolveCurrentUserId();
                    ...
                    String ctxOrgId = com.operativus.agentmanager.core.callback.AgentContextHolder.getOrgId();
    ...
    private AgentMessage mapToEntity(String sessionId, Message msg) {
        ...
        entity.setRequiresEncryption(com.operativus.agentmanager.core.callback.AgentContextHolder.getRequiresEncryption());
        return entity;
    }
