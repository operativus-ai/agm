 ...
 */
@Service
public class SettingsService implements ConfigurationProvider, com.operativus.agentmanager.core.registry.SettingsOperations {
    ...
    public com.operativus.agentmanager.core.entity.FinOpsRiskTier resolveFinOpsRiskTier(
            com.operativus.agentmanager.core.entity.FinOpsRiskTier agentValue) {
        if (agentValue != null) return agentValue;
        return globalSettingRepository.findById(KEY_DEFAULT_FINOPS_RISK_TIER)
                .map(GlobalSetting::getValue)
                .map(com.operativus.agentmanager.core.entity.FinOpsRiskTier::fromString)
                .orElse(com.operativus.agentmanager.core.entity.FinOpsRiskTier.LOW_RISK);
    }

    /**
     * @summary Resolves the effective finOpsTokenBudget: explicit agent value -> risk tier default -> null (no limit).
     */
    public Long resolveFinOpsTokenBudget(Long agentBudget, com.operativus.agentmanager.core.entity.FinOpsRiskTier riskTier) {
        if (agentBudget != null) return agentBudget;
        com.operativus.agentmanager.core.entity.FinOpsRiskTier effectiveTier = resolveFinOpsRiskTier(riskTier);
