...
import com.operativus.agentmanager.core.model.AuthModels.*;
 ...
 *   REGISTER) — the {@link com.operativus.agentmanager.control.config.interceptor.SystemAuditInterceptor}
...
public class AuthController {
    ...
    private final com.operativus.agentmanager.control.service.PasswordResetService passwordResetService;

    public AuthController(AuthenticationManager authenticationManager, UserRepository userRepository,
                          PasswordEncoder encoder, JwtUtils jwtUtils,
                          SystemAuditService systemAuditService,
                          com.operativus.agentmanager.control.service.PasswordResetService passwordResetService) {
    ...
    public ResponseEntity<Void> requestPasswordReset(
            ...
            com.operativus.agentmanager.control.dto.PasswordResetDtos.PasswordResetRequest body,
    ...
    public ResponseEntity<Void> confirmPasswordReset(
            @jakarta.validation.Valid @RequestBody
            com.operativus.agentmanager.control.dto.PasswordResetDtos.PasswordResetConfirm body) {
