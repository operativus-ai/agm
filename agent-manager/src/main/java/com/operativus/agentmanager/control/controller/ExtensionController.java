...
import com.operativus.agentmanager.core.model.ExtensionRegistrationDTO;
import com.operativus.agentmanager.core.model.McpTransport;
import com.operativus.agentmanager.core.model.ValidationResponseDTO;
...
public class ExtensionController {
    ...
    public ResponseEntity<List<ExtensionRegistrationDTO>> getExtensions() {
        ...
        for (com.operativus.agentmanager.core.spi.AgentHookExtension spiHook :
                java.util.ServiceLoader.load(com.operativus.agentmanager.core.spi.AgentHookExtension.class)) {
