...
import com.operativus.agentmanager.control.service.SessionService;
...
public class SessionController {
    ...
    public List<com.operativus.agentmanager.core.entity.AgentRun> getSessionRuns(@PathVariable String sessionId) {
        String permittedUserId = isCurrentUserAdmin() ? null : currentUserId();
