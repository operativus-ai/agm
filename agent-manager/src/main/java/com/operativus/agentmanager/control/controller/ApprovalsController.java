...
import com.operativus.agentmanager.core.model.HumanReviewDecideRequest;
import com.operativus.agentmanager.core.model.HumanReviewDecideResponse;
...
public class ApprovalsController {
    ...
    public ResponseEntity<ApprovalDTO> getApproval(@PathVariable("id") String id) {
        ...
        } catch (com.operativus.agentmanager.core.exception.ResourceNotFoundException nf) {
