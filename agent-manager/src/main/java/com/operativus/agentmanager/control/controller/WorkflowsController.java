...
import com.operativus.agentmanager.compute.workflow.WorkflowDagValidator;
...
import com.operativus.agentmanager.control.service.queue.WorkflowExecutionJobHandler;
import com.operativus.agentmanager.control.service.queue.WorkflowContinueJobHandler;
import com.operativus.agentmanager.control.service.queue.WorkflowResumeJobHandler;
...
import com.operativus.agentmanager.core.model.ContinueWorkflowRequest;
import com.operativus.agentmanager.core.model.RouterStepConfig;
import com.operativus.agentmanager.core.model.WorkflowRouteOptionsResponse;
import com.operativus.agentmanager.core.model.enums.RunStatus;
import com.operativus.agentmanager.core.model.ExecuteWorkflowRequest;
import com.operativus.agentmanager.core.model.ResumeWorkflowRequest;
import com.operativus.agentmanager.core.model.TenantConstants;
import com.operativus.agentmanager.core.model.WorkflowContinueResponse;
import com.operativus.agentmanager.core.model.WorkflowDTO;
import com.operativus.agentmanager.core.model.WorkflowEdgeDTO;
import com.operativus.agentmanager.core.model.WorkflowGraphResponse;
import com.operativus.agentmanager.core.model.WorkflowValidationResult;
import com.operativus.agentmanager.core.model.WorkflowLayoutDTO;
import com.operativus.agentmanager.core.model.NodePosition;
import com.operativus.agentmanager.core.entity.WorkflowNodeLayout;
import com.operativus.agentmanager.core.model.WorkflowNodeRunDTO;
import com.operativus.agentmanager.core.model.CreateWorkflowEdgeRequest;
import com.operativus.agentmanager.core.model.UpdateWorkflowEdgeRequest;
import com.operativus.agentmanager.core.model.WorkflowExecutionResponse;
import com.operativus.agentmanager.core.model.WorkflowResumeResponse;
import com.operativus.agentmanager.core.model.WorkflowRunResponse;
...
public class WorkflowsController {
    ...
    private final com.operativus.agentmanager.control.repository.WorkflowNodeRunRepository workflowNodeRunRepository;
    private final com.operativus.agentmanager.control.repository.WorkflowNodeLayoutRepository workflowNodeLayoutRepository;
    ...
    public WorkflowsController(WorkflowService workflowService,
                               ...
                               com.operativus.agentmanager.control.repository.WorkflowNodeRunRepository workflowNodeRunRepository,
                               com.operativus.agentmanager.control.repository.WorkflowNodeLayoutRepository workflowNodeLayoutRepository,
    ...
    public ResponseEntity<List<com.operativus.agentmanager.core.model.WorkflowChildNodeRunsDTO>> getRunChildNodeRuns(
        ...
        String prefix = runId + "#";
        Map<String, List<com.operativus.agentmanager.core.entity.WorkflowNodeRun>> byChildRun =
                workflowNodeRunRepository.findByRunIdStartingWithOrderByStartedAtAsc(prefix).stream()
                        .collect(java.util.stream.Collectors.groupingBy(
                                com.operativus.agentmanager.core.entity.WorkflowNodeRun::getRunId,
                                java.util.LinkedHashMap::new,
                                java.util.stream.Collectors.toList()));
        List<com.operativus.agentmanager.core.model.WorkflowChildNodeRunsDTO> groups =
                byChildRun.entrySet().stream().map(e -> {
                    ...
                    return new com.operativus.agentmanager.core.model.WorkflowChildNodeRunsDTO(
     ...
     *     {@link com.operativus.agentmanager.integration.runs.BackgroundRunsRuntimeTest}.
     */
