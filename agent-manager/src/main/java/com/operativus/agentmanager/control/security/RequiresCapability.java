 ...
 * to derive the tool's {@link com.operativus.agentmanager.core.model.ToolCategory} for
 * the {@code GET /api/tools} listing read by the UI (see
 * {@link com.operativus.agentmanager.control.controller.ToolController#buildToolCategoryMap}).
 *
