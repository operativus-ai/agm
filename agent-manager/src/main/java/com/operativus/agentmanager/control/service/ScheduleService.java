...
import com.operativus.agentmanager.core.model.ScheduleRunDTO;
...
public class ScheduleService implements ScheduleOperations {
    ...
    private final com.operativus.agentmanager.control.repository.SpotBatchJobRepository spotBatchJobRepository;
    ...
    public ScheduleService(ScheduleRepository scheduleRepository, ScheduleRunRepository scheduleRunRepository,
                           ...
                           com.operativus.agentmanager.control.repository.SpotBatchJobRepository spotBatchJobRepository,
     ...
     */
    public List<com.operativus.agentmanager.core.model.SpotBatchJobDTO> getSpotBatches() {
        return spotBatchJobRepository.findAllByOrgId(callerOrgId()).stream()
                .map(entity -> new com.operativus.agentmanager.core.model.SpotBatchJobDTO(
                        entity.getId(),
                        entity.getJob(),
                        entity.getStatus(),
