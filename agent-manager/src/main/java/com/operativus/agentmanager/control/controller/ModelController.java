...
public class ModelController {
     ...
     *     Always responds 200 OK with a {@link com.operativus.agentmanager.core.model.ModelPingResult}
     ...
     */
    @PostMapping("/{id}/test")
    public ResponseEntity<com.operativus.agentmanager.core.model.ModelPingResult> testExistingModel(@PathVariable("id") String id) {
