...
public class ModelService implements ModelOperations {
    ...
    private final com.operativus.agentmanager.control.repository.AgentRepository agentRepository;
     ...
     *  {@link com.operativus.agentmanager.compute.security.ModelRateLimitGuard#invalidate}
     *  to evict the cached limiter (Anti-pattern A1 mitigation in
     *  {@code docs/plans-execute-whats-left.md}). */
    private final org.springframework.beans.factory.ObjectProvider<com.operativus.agentmanager.compute.security.ModelRateLimitGuard> rateLimitGuardProvider;

    public ModelService(ModelRepository modelRepository,
                        com.operativus.agentmanager.control.repository.AgentRepository agentRepository,
                        RunRepository runRepository,
                        SettingsService settingsService,
                        List<DynamicModelProvider> providers,
                        org.springframework.beans.factory.ObjectProvider<com.operativus.agentmanager.compute.security.ModelRateLimitGuard> rateLimitGuardProvider) {
     ...
     *     affordance). Must invalidate the cached {@link com.operativus.agentmanager.compute.security.ModelRateLimitGuard}
    ...
    public void clearRateLimit(String id) {
        ...
        com.operativus.agentmanager.compute.security.ModelRateLimitGuard guard =
     ...
     *     the {@link com.operativus.agentmanager.control.security.OutboundApiKeyConverter}
    ...
    public void deleteModel(String id) {
        List<com.operativus.agentmanager.core.entity.AgentEntity> dependents = agentRepository.findByModelId(id);
        if (!dependents.isEmpty()) {
            String names = dependents.stream()
                    .map(com.operativus.agentmanager.core.entity.AgentEntity::getName)
    ...
    public void testConnection(ModelRequest request) {
        ...
        try {
            ...
            if (com.operativus.agentmanager.core.entity.ModelType.EMBEDDING.equals(request.modelType())) {
    ...
    @Override
    @PreAuthorize("hasRole('ADMIN')")
    public com.operativus.agentmanager.core.model.ModelPingResult pingExistingModel(String id) {
        ModelEntity entity = modelRepository.findById(id)
                .orElseThrow(() -> new ResourceNotFoundException("Model", id));
     ...
     */
    public com.operativus.agentmanager.core.model.ModelPingResult pingEntity(ModelEntity entity) {
        ...
        try {
            ...
            if (provider == null) {
                ...
                return new com.operativus.agentmanager.core.model.ModelPingResult(
                        id, false, elapsed, "No provider registered for " + entity.getProvider());
            }
            if (com.operativus.agentmanager.core.entity.ModelType.EMBEDDING.equals(entity.getModelType())) {
            ...
            return new com.operativus.agentmanager.core.model.ModelPingResult(id, true, elapsed, null);
        } catch (Exception e) {
            long elapsed = System.currentTimeMillis() - start;
            log.warn("Ping failed for model {} ({}ms): {}", id, elapsed, e.getMessage());
            return new com.operativus.agentmanager.core.model.ModelPingResult(id, false, elapsed, e.getMessage());
        }
    }
