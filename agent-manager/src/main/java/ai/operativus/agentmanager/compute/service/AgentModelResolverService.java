...
public class AgentModelResolverService {
     ...
     *  See {@link ai.operativus.agentmanager.compute.DynamicProviderInitializer}. */
    private final java.util.Map<String, ai.operativus.agentmanager.compute.provider.DynamicModelProvider> dynamicProviders;

    public AgentModelResolverService(SettingsOperations settingsService,
                                      ModelOperations modelService,
                                      org.springframework.core.env.Environment environment,
                                      java.util.List<ai.operativus.agentmanager.compute.provider.DynamicModelProvider> providers) {
        this.settingsService = settingsService;
        this.modelService = modelService;
        this.environment = environment;

        java.util.Map<String, ai.operativus.agentmanager.compute.provider.DynamicModelProvider> reg = new java.util.HashMap<>();
        for (ai.operativus.agentmanager.compute.provider.DynamicModelProvider p : providers) {
    ...
    private org.springframework.ai.chat.model.ChatModel buildViaDynamicProvider(String modelId) {
        ...
        ai.operativus.agentmanager.compute.provider.DynamicModelProvider provider =
