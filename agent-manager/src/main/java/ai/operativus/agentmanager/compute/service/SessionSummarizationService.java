...
public class SessionSummarizationService {
    ...
    public SessionSummarizationService(MessageRepository messageRepository,
                                       ...
                                       ai.operativus.agentmanager.core.registry.SettingsOperations settingsService,
    ...
    public void evaluateSessionForSummarization(String sessionId) {
        ...
        sessionRepository.findById(sessionId).ifPresent(session -> {
            ...
            if (session.getAgentId() != null) {
                ai.operativus.agentmanager.core.model.definitions.AgentDefinition def = agentRegistry.findById(session.getAgentId(), session.getOrgId());
                if (def != null) {
