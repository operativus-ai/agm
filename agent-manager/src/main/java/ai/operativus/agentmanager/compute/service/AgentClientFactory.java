...
import ai.operativus.agentmanager.core.model.SystemTool;
import ai.operativus.agentmanager.core.model.ModelFamily;
import ai.operativus.agentmanager.core.model.ModelProviderNames;
import ai.operativus.agentmanager.compute.advisor.AgentLoggingAdvisor;
import ai.operativus.agentmanager.compute.advisor.ContentSafetyAdvisor;
import ai.operativus.agentmanager.compute.advisor.ExtensionHookAdvisor;
import ai.operativus.agentmanager.compute.advisor.DocumentReRanker;
import ai.operativus.agentmanager.compute.advisor.LlmDocumentReRanker;
import ai.operativus.agentmanager.compute.advisor.PassthroughDocumentReRanker;
import ai.operativus.agentmanager.compute.advisor.PIIAnonymizationAdvisor;
import ai.operativus.agentmanager.compute.advisor.PromptInjectionAdvisor;
import ai.operativus.agentmanager.compute.advisor.StatefulStreamingPIIAdvisor;
import ai.operativus.agentmanager.compute.monitoring.GenAiMetricsAdvisor;
import ai.operativus.agentmanager.compute.skill.SkillInjector;
...
import ai.operativus.agentmanager.compute.advisor.VectorStoreCacheAdvisor;
import ai.operativus.agentmanager.compute.advisor.AdvancedRagAdvisor;
...
import ai.operativus.agentmanager.core.registry.ToolRegistry;
...
public class AgentClientFactory implements ToolRegistry {
    ...
    private final ai.operativus.agentmanager.core.callback.AugmentedToolCallbackProvider callbackProvider;
    ...
    private final ai.operativus.agentmanager.core.registry.MemoryOperations memoryService;
    private final KnowledgeService knowledgeService;
    private final ai.operativus.agentmanager.control.service.PersistentChatMemory persistentChatMemory;
    ...
    private final Map<String, ai.operativus.agentmanager.compute.provider.DynamicModelProvider> modelProviderRegistry = new java.util.concurrent.ConcurrentHashMap<>();
     ...
     *  uses the LLM {@link ai.operativus.agentmanager.compute.advisor.LlmDocumentReRanker} to refine the
     *  RRF pool; otherwise the {@link ai.operativus.agentmanager.compute.advisor.PassthroughDocumentReRanker}. */
    ...
    private final ai.operativus.agentmanager.control.service.SettingsService settingsService;
    ...
    private final List<ai.operativus.agentmanager.core.spi.EnterpriseAdvisorContributor> advisorContributors;
    ...
    static List<org.springframework.ai.chat.client.advisor.api.Advisor> contributedAdvisors(
            List<ai.operativus.agentmanager.core.spi.EnterpriseAdvisorContributor> contributors,
            AgentDefinition def) {
        ...
        return contributors.stream()
                .sorted(java.util.Comparator.comparingInt(
                        ai.operativus.agentmanager.core.spi.EnterpriseAdvisorContributor::order))
                .flatMap(c -> {
    ...
    public AgentClientFactory(AgentRegistry agentRegistry,
                              ai.operativus.agentmanager.core.callback.AugmentedToolCallbackProvider callbackProvider,
                              ...
                              List<ai.operativus.agentmanager.compute.provider.DynamicModelProvider> dynamicModelProviders,
                              ...
                              ai.operativus.agentmanager.core.registry.MemoryOperations memoryService,
                              KnowledgeService knowledgeService,
                              ai.operativus.agentmanager.control.service.PersistentChatMemory persistentChatMemory,
                              ...
                              ai.operativus.agentmanager.control.service.SettingsService settingsService,
                              io.micrometer.core.instrument.MeterRegistry meterRegistry,
                              Optional<SkillInjector> skillInjector,
                              List<ai.operativus.agentmanager.core.spi.EnterpriseAdvisorContributor> advisorContributors,
        ...
        if (dynamicModelProviders != null) {
            for (ai.operativus.agentmanager.compute.provider.DynamicModelProvider provider : dynamicModelProviders) {
    ...
    public ChatClient buildChatClient(AgentDefinition def, String sessionId, String userId, String orgId, RunOptions runOptions) {
        ...
        builder.defaultAdvisors(
                ...
                new ai.operativus.agentmanager.compute.advisor.AgentIdInjectionAdvisor(def.id(), sessionId),
        ...
        if (def.enforceJsonOutput()) {
            ...
            builder.defaultAdvisors(new ai.operativus.agentmanager.compute.advisor.StructuredOutputRetryAdvisor(structuredOutputMaxRetries, meterRegistry));
        }

        if (userId != null && !userId.isBlank()) {
            builder.defaultAdvisors(new ai.operativus.agentmanager.compute.advisor.AgenticMemoryAdvisor(this.memoryService, userId));
        }
        ...
        if (isMemoryEnabled && addHistory) {
            ...
            builder.defaultAdvisors(
                    new ai.operativus.agentmanager.compute.advisor.ConversationIdInjectionAdvisor(sessionId),
                    MessageChatMemoryAdvisor.builder(persistentChatMemory).build(),
                    new ai.operativus.agentmanager.compute.advisor.ConversationIdResponseAdvisor());
        }
        ...
        try {
            ...
            return ChatClient.builder(chatModel)
                    .defaultAdvisors(
                            ...
                            this.genAiMetricsAdvisor)
                    .build();
        } catch (ai.operativus.agentmanager.core.exception.MissingProviderKeyException e) {
    ...
    private org.springframework.ai.chat.model.ChatModel instantiateCustomChatModel(AgentDefinition def, ModelEntity me) {
        return customChatModelsCache.computeIfAbsent(me.getId(), id -> {
            ...
            ai.operativus.agentmanager.compute.provider.DynamicModelProvider provider = modelProviderRegistry.get(me.getProvider().toUpperCase());
            if (provider != null) {
