...
public class ToolCompressionService {
    ...
    private final ai.operativus.agentmanager.compute.service.AgentModelResolverService modelResolver;
    private final ai.operativus.agentmanager.core.registry.SettingsOperations settingsService;

    public ToolCompressionService(ai.operativus.agentmanager.compute.service.AgentModelResolverService modelResolver, ai.operativus.agentmanager.core.registry.SettingsOperations settingsService) {
     ...
     */
    public String compressIfRequired(String toolName, String payload, ai.operativus.agentmanager.core.model.definitions.AgentDefinition agentDef) {
