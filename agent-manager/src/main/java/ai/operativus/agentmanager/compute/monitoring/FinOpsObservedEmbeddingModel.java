...
public class FinOpsObservedEmbeddingModel implements EmbeddingModel {
    ...
    public EmbeddingResponse call(EmbeddingRequest request) {
        ...
        } catch (ai.operativus.agentmanager.control.finops.exception.FinOpsBudgetExhaustedException ex) {
    ...
    private String safeGetSessionId() {
        try {
            String id = ai.operativus.agentmanager.core.callback.AgentContextHolder.getSessionId();
