...
public class AgentContextHolder {
     ...
     *  The lifecycle tier ({@link ai.operativus.agentmanager.core.event.AgentRunEventType#isAlwaysEmitted()})
    ...
    public static String getOrgId() {
        ...
        if (auth != null && auth.isAuthenticated()
                && auth.getPrincipal() instanceof ai.operativus.agentmanager.control.security.UserDetailsImpl ud) {
            return ud.getOrgId();
        }
        return null;
    }
