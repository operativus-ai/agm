...
public interface ApprovalOperations {
    ApprovalDTO createApprovalRequest(String runId, String sessionId, String agentId, String toolName, String toolArguments, String message, String requestedBy, String reasoningTrace, String impactAssessment, ai.operativus.agentmanager.core.model.DecisionPackage.DecisionTier tier);
}
