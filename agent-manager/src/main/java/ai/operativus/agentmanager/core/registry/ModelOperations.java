...
public interface ModelOperations {
    ...
    Optional<ai.operativus.agentmanager.core.entity.ModelEntity> getModelEntityById(String id);
     ...
     */
    ai.operativus.agentmanager.core.model.ModelPingResult pingExistingModel(String id);
     ...
     *     Throws {@link ai.operativus.agentmanager.core.exception.ResourceNotFoundException}
