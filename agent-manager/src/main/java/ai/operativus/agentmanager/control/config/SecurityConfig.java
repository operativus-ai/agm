...
import ai.operativus.agentmanager.control.security.AgentPermissionEvaluator;
import ai.operativus.agentmanager.control.security.ApiKeyAuthenticationFilter;
import ai.operativus.agentmanager.control.security.AuthEntryPointJwt;
import ai.operativus.agentmanager.control.security.JwtAuthenticationFilter;
import ai.operativus.agentmanager.control.security.UserDetailsServiceImpl;
...
public class SecurityConfig {
    ...
    private final ai.operativus.agentmanager.control.security.SseTokenAuthFilter sseTokenAuthFilter;
    ...
    public SecurityConfig(
            ...
            ai.operativus.agentmanager.control.security.SseTokenAuthFilter sseTokenAuthFilter) {
