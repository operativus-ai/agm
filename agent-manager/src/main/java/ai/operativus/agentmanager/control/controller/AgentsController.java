...
import ai.operativus.agentmanager.control.security.MediaUrlFetcher;
...
import ai.operativus.agentmanager.control.service.queue.KnowledgeIngestionJobHandler;
...
public class AgentsController {
    ...
    public ai.operativus.agentmanager.core.model.AgentRunStatusDTO runBackground(@PathVariable String agentId, @RequestBody RunRequest request) {
        String sessionId = resolveSessionId(request.sessionId());
        String orgId = resolveCallerOrgId(request);
        String userId = resolveCallerUserId(request);
        Boolean followups = request.generateFollowups() != null ? request.generateFollowups() : false;
        ...
        return new ai.operativus.agentmanager.core.model.AgentRunStatusDTO(runId, "QUEUED");
    }
    ...
    public List<ai.operativus.agentmanager.core.entity.AgentRun> getRunStatusBatch(
