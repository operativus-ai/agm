...
import ai.operativus.agentmanager.control.a2a.A2ATaskExecutor;
import ai.operativus.agentmanager.control.a2a.model.A2aTaskStatus;
import ai.operativus.agentmanager.control.a2a.model.AgentCard;
...
import ai.operativus.agentmanager.control.a2a.model.RemoteAgentRegistration;
...
public class A2AController {
    ...
    private String validateBaseUrl(String rawUrl) {
        return ai.operativus.agentmanager.core.security.SsrfGuard.validate(rawUrl, false);
    }
    ...
    public SseEmitter submitTask(@Valid @RequestBody A2aTaskRequest request) {
        ...
        String effectiveTraceId = request.traceId() != null
            ? request.traceId()
            : org.slf4j.MDC.get(
                ai.operativus.agentmanager.control.security.A2aTraceContextFilter.MDC_TRACE_ID_KEY);
