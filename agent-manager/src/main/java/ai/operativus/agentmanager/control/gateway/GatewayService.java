package ai.operativus.agentmanager.control.gateway;
...
public class GatewayService {
    ...
    private final ai.operativus.agentmanager.control.security.GatewayPromptInjectionScanner promptInjectionScanner;

    public GatewayService(ManifestParser manifestParser, ai.operativus.agentmanager.control.security.GatewayPromptInjectionScanner promptInjectionScanner) {
