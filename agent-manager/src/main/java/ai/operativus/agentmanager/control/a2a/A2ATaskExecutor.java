...
import ai.operativus.agentmanager.control.security.A2aTraceContextFilter;
...
public class A2ATaskExecutor {
    ...
    private void executeTask(A2aTaskRequest request, AgentEmitter emitter, String callerOrgId) {
        ...
        try {
            ...
            if (response.status() == ai.operativus.agentmanager.core.model.enums.RunStatus.PAUSED) {
