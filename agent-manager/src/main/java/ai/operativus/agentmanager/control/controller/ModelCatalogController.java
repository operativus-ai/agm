...
import ai.operativus.agentmanager.control.dto.ModelCatalogResponse;
import ai.operativus.agentmanager.control.service.ModelCatalogService;
 ...
 *     — that path is called from {@link ai.operativus.agentmanager.control.service.ModelService}
