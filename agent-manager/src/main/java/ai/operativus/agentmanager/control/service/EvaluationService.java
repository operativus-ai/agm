...
import ai.operativus.agentmanager.control.service.scoring.Scorer;
...
import ai.operativus.agentmanager.core.registry.StreamRegistry;
...
public class EvaluationService implements EvaluationOperations {
    ...
    public EvaluationSuite createSuite(String name, String description, String createdBy) {
        ...
        String orgId = ai.operativus.agentmanager.core.callback.AgentContextHolder.getOrgId();
    ...
    private void executeEvaluationRun(String runId, String agentId, String suiteId,
            ai.operativus.agentmanager.core.callback.AgentContextSnapshot snapshot) {
