 ...
 *   table. Called from (a) {@link ai.operativus.agentmanager.control.config.interceptor.SystemAuditInterceptor}
 *   after every successful non-agent HTTP mutation, (b) {@link ai.operativus.agentmanager.control.controller.AuthController}
 *   on login success/failure/logout, and (c)
 *   {@link ai.operativus.agentmanager.control.controller.SystemAuditLogController} for the admin
