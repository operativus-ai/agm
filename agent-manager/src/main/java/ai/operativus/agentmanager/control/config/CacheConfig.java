...
public class CacheConfig implements CachingConfigurer {
     ...
     * <ul>
     *   <li>{@code ai.operativus.agentmanager.*} — our domain entities + DTOs
    ...
    static PolymorphicTypeValidator strictCachePolymorphicTypeValidator() {
        ...
        return BasicPolymorphicTypeValidator.builder()
                .allowIfSubType("ai.operativus.agentmanager.")
    ...
    public RedisCacheManager cacheManager(
        ...
        RedisCacheConfiguration config = RedisCacheConfiguration.defaultCacheConfig()
            // v3: the ai.operativus package rename changed every cached value's @class ids —
            // a fresh prefix orphans v2 entries (rejected by the new allowlist) until TTL purges them.
