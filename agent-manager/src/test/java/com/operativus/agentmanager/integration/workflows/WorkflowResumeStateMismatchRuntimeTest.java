 ...
 *   matrix. The service is invoked by {@link com.operativus.agentmanager.control.service.queue.WorkflowResumeJobHandler}
 *   on the back of a {@code WORKFLOW_RESUME} background job; the controller enqueues without
 *   pre-validating run state (see {@link com.operativus.agentmanager.control.controller.WorkflowsController#resumeWorkflowRun}
