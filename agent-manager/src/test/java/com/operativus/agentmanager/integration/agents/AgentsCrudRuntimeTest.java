 ...
 *   {@link com.operativus.agentmanager.control.controller.AgentAdminController}
 *   → {@link com.operativus.agentmanager.control.service.AgentAdminService}) and the
 *   registry-backed {@code GET /api/agents} listing (handled by
 *   {@link com.operativus.agentmanager.control.controller.AgentsController}
 *   → {@link com.operativus.agentmanager.control.registry.DatabaseAgentRegistry}).
 ...
 *   - {@link com.operativus.agentmanager.core.model.definitions.AgentDefinition} declares
...
public class AgentsCrudRuntimeTest extends BaseIntegrationTest {
     ...
     * {@link com.operativus.agentmanager.core.entity.ModelEntity}: id, name, provider,
