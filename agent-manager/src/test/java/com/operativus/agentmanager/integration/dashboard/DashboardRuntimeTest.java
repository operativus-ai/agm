 ...
 *   - {@link com.operativus.agentmanager.control.service.MonitoringService#getGlobalStats()}
 ...
 *     {@link com.operativus.agentmanager.control.registry.DatabaseAgentRegistry#findAll(boolean)},
 *     which calls {@code agentRepository.findByOrgIdAndActiveTrue(orgId)}. The {@code orgId} is
 *     resolved from {@link com.operativus.agentmanager.core.callback.AgentContextHolder#getOrgId()},
 *     which {@link com.operativus.agentmanager.control.security.TenantContextFilter} binds for the
