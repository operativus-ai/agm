...
public class KnowledgeServiceTest {
    ...
    void setUp() {
        ...
        mockedContext.when(com.operativus.agentmanager.core.callback.AgentContextHolder::getOrgId).thenReturn("TEST_ORG");
        mockedContext.when(com.operativus.agentmanager.core.callback.AgentContextHolder::getAllowedKnowledgeBaseIds).thenReturn(java.util.Collections.emptyList());
    ...
    void ingestText_ValidSetup_SavesChunksAndUpdatesMetadata() {
        ...
        verify(mockContent).setStatus(com.operativus.agentmanager.core.model.enums.RunStatus.COMPLETED);
