...
public class AgentModelResolverServiceTest {
    ...
    @Mock
    private ai.operativus.agentmanager.compute.provider.DynamicModelProvider openAiProvider;

    @Mock
    private ai.operativus.agentmanager.compute.provider.DynamicModelProvider googleProvider;
