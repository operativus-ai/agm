...
class AdvisorChainOrderingArchTest {
    ...
    void genAiMetricsAdvisor_pinnedAt_MAX_VALUE_terminalSlot() {
        ...
        GenAiMetricsAdvisor advisor = new GenAiMetricsAdvisor(
                ...
                mock(ai.operativus.agentmanager.control.approval.HitlPauseHandler.class),
                mock(ai.operativus.agentmanager.core.event.AgentRunEventBus.class),
                mock(ai.operativus.agentmanager.control.finops.service.BurnRateMonitorService.class),
                null);
