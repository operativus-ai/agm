...
public class AgentServiceTest {
    ...
    @Mock
    private ai.operativus.agentmanager.compute.security.ModelRateLimitGuard modelRateLimitGuard;
    @Mock
    private ai.operativus.agentmanager.control.finops.service.BudgetPolicyService budgetPolicyService;
    @Mock
    private ai.operativus.agentmanager.control.finops.service.DailySpendService dailySpendService;
    ...
    void teamMemberPaused_finalizesTeamAsPaused_withLiftedRequiredAction() {
        ...
        ai.operativus.agentmanager.core.model.RequiredAction childPayload =
                ai.operativus.agentmanager.core.model.RequiredAction.toolApproval(
                        "delete_file", "{}", "approval-xyz", "trace-1", "lineage", "depth=1");
        ai.operativus.agentmanager.core.exception.TeamMemberPausedException tpe =
                new ai.operativus.agentmanager.core.exception.TeamMemberPausedException(
        ...
        ai.operativus.agentmanager.core.model.RequiredAction lifted =
                (ai.operativus.agentmanager.core.model.RequiredAction) out.metadata().get("requiredAction");
    ...
    void teamSwarmEscalation_finalizesTeamAsPaused_withSwarmEscalationPayload() {
        ...
        ai.operativus.agentmanager.core.exception.SwarmEscalationException se =
                new ai.operativus.agentmanager.core.exception.SwarmEscalationException(
        ...
        assertEquals(RunStatus.PAUSED, out.status());
        ai.operativus.agentmanager.core.model.RequiredAction ra =
                (ai.operativus.agentmanager.core.model.RequiredAction) out.metadata().get("requiredAction");
        assertEquals(ai.operativus.agentmanager.core.model.RequiredActionType.SWARM_ESCALATION_APPROVAL, ra.type());
    ...
    void teamApprovalRequired_finalizesTeamAsPaused_withToolApprovalPayload() {
        ...
        ai.operativus.agentmanager.core.exception.ApprovalRequiredException are =
                new ai.operativus.agentmanager.core.exception.ApprovalRequiredException(
        ...
        ai.operativus.agentmanager.core.model.RequiredAction ra =
                (ai.operativus.agentmanager.core.model.RequiredAction) out.metadata().get("requiredAction");
        assertEquals(ai.operativus.agentmanager.core.model.RequiredActionType.TOOL_APPROVAL, ra.type());
    ...
    void continueRun_teamLevelEscalation_rejectsWithReinvokeHint() throws Exception {
        ...
        ai.operativus.agentmanager.core.model.RequiredAction f3Payload =
                ai.operativus.agentmanager.core.model.RequiredAction.swarmEscalation(
