...
import ai.operativus.agentmanager.compute.teams.OrchestrationMemoryScopes;
import ai.operativus.agentmanager.compute.teams.SequentialOrchestrator;
 ...
 * {@code teams.isolate_memory} column → {@link ai.operativus.agentmanager.core.entity.Team}
...
public class TeamIsolateMemoryRuntimeTest extends BaseIntegrationTest {
    ...
    @Autowired private ai.operativus.agentmanager.control.repository.AgentRepository agentRepository;
    @Autowired private ai.operativus.agentmanager.control.repository.TeamRepository teamRepository;
    ...
    private String persistTeam(String prefix, List<String> memberIds, boolean isolateMemory) {
        String id = prefix + "-" + UUID.randomUUID();
        ai.operativus.agentmanager.core.entity.Team team = new ai.operativus.agentmanager.core.entity.Team();
        team.setId(id);
