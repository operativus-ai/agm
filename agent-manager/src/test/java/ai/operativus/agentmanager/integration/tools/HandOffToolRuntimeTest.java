...
import ai.operativus.agentmanager.compute.tools.HandOffTool;
...
import ai.operativus.agentmanager.core.exception.SwarmHandOffException;
 ...
 *   {@link ai.operativus.agentmanager.compute.tools.HandOffTool#hand_off_to_agent}
 *   — the Swarm-style voluntary handoff primitive that an agent invokes (as a
 *   Spring AI tool) to surrender control to a peer.
 *
 *   The unit-level {@link ai.operativus.agentmanager.compute.tools.HandOffToolTest}
...
public class HandOffToolRuntimeTest extends BaseIntegrationTest {
     ...
     * the ScopedValue that {@link ai.operativus.agentmanager.compute.service.TeamOrchestrationEngine}
     * binds at executeSync/executeStream entry. Exercises the handoff path through
     * the real {@link ai.operativus.agentmanager.compute.teams.TransitionValidator}
