 ...
 *   {@link ai.operativus.agentmanager.control.controller.ExtensionController}
 *   ({@code /api/v1/extensions} CRUD), the per-agent
 *   {@link ai.operativus.agentmanager.compute.advisor.ExtensionHookAdvisor}
 ...
 *   - Agent post-hook wiring: {@link ai.operativus.agentmanager.core.entity.AgentEntity}
...
public class ExtensionsRuntimeTest extends BaseIntegrationTest {
     ...
     *   which exercises {@link ai.operativus.agentmanager.core.spi.WorkflowStepExecutorExtension}
