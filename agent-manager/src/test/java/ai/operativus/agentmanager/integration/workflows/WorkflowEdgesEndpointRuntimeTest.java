...
/**
 * Pins the REQ-DR-5 workflow DAG edge REST surface on {@link ai.operativus.agentmanager.control.controller.WorkflowsController}:
 * list / graph / add / delete edges, plus validation (self-loop, non-member step, duplicate,
 * cycle rejection via {@link ai.operativus.agentmanager.compute.workflow.WorkflowDagValidator})
