 ...
 *   surface — {@link ai.operativus.agentmanager.control.controller.EvaluationController}
 *   → {@link ai.operativus.agentmanager.control.service.EvaluationService} →
 *   {@link ai.operativus.agentmanager.control.service.queue.EvaluationRunJobHandler}.
 ...
 *   - {@link ai.operativus.agentmanager.control.controller.EvaluationController} performs
 ...
 *     {@link ai.operativus.agentmanager.control.service.PersistentJobQueueService} and
 *     returns 202 + {@code {jobId: ...}}. {@link ai.operativus.agentmanager.control.service.queue.EvaluationRunJobHandler#execute}
 *     invokes {@link ai.operativus.agentmanager.control.service.EvaluationService#runSuite}
 ...
 *     completion.
 *   - {@link ai.operativus.agentmanager.control.service.EvaluationService#selectScorer}
 ...
 *   - {@link ai.operativus.agentmanager.control.service.scoring.RegexMatchScorer} uses
