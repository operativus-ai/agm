 ...
 *   - {@link ai.operativus.agentmanager.control.service.SessionService#SESSION_TTL_HOURS}
 *     is a hardcoded 24h cutoff. Both {@code listSessions} (filter on {@code updated_at >
 *     now() - 24h}) and {@code getSession} (throws {@link ai.operativus.agentmanager.core.exception.BusinessValidationException}
 ...
 *     {@link ai.operativus.agentmanager.control.service.PersistentChatMemory} on the
 *     first ChatClient call inside a run. {@code orgId} is now read from
 *     {@link ai.operativus.agentmanager.core.callback.AgentContextHolder#getOrgId()} so
