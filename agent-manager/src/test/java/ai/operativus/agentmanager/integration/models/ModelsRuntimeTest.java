 ...
 *   {@link ai.operativus.agentmanager.control.controller.ModelController} →
 *   {@link ai.operativus.agentmanager.control.service.ModelService}. Pins RBAC (all methods
 ...
 *   - {@link ai.operativus.agentmanager.control.security.OutboundApiKeyConverter} is
 ...
 *   - The {@code ModelService.providerRegistry} is built from every {@link ai.operativus.agentmanager.compute.provider.DynamicModelProvider}
 ...
 *     {@link ai.operativus.agentmanager.core.exception.BusinessValidationException} that
 ...
 *     in case (c) resolves a real {@link ai.operativus.agentmanager.compute.provider.DynamicModelProvider}
 *     keyed by {@code "FAKE"} and calls {@link ai.operativus.agentmanager.integration.support.FakeChatModel#call}.
...
public class ModelsRuntimeTest extends BaseIntegrationTest {
    ...
    /**
     * JDBC-seeds a minimal models row with the NOT NULL columns from {@link ai.operativus.agentmanager.core.entity.ModelEntity}:
     ...
     * insert, because {@link ai.operativus.agentmanager.core.entity.ModelEntity#apiKey} has
