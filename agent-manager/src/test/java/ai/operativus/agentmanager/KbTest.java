...
public class KbTest {
    ...
    public void testSaving() throws Exception {
        ...
        ai.operativus.agentmanager.core.entity.KnowledgeBase kb = new ai.operativus.agentmanager.core.entity.KnowledgeBase("spring boot docs " + java.util.UUID.randomUUID(), "auto gen");
