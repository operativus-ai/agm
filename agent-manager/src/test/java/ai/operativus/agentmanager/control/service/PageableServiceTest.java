...
public class PageableServiceTest {
    ...
    class WorkflowServicePaginationTests {
        ...
        void setUp() {
            mockedContext = org.mockito.Mockito.mockStatic(
                    ai.operativus.agentmanager.core.callback.AgentContextHolder.class);
    ...
    class ModelServicePaginationTests {
        ...
        @Mock private ai.operativus.agentmanager.control.repository.AgentRepository agentRepository;
        @Mock private ai.operativus.agentmanager.control.repository.RunRepository runRepository;
