...
public class AgentAdminServiceTest {
    ...
    void updateAgent_persistsHumanReview_fallbackModelIds_finOpsRiskTier_optimizationModelId() {
        ...
        ai.operativus.agentmanager.core.model.HumanReview hr =
                new ai.operativus.agentmanager.core.model.HumanReview(
                        true, null, null,
                        ai.operativus.agentmanager.core.model.enums.OnRejectPolicy.SKIP,
