...
class WorkflowServiceTest {
    ...
    void setUp() {
        service = new WorkflowService(workflowRepository, workflowStepRepository, workflowRunRepository,
                ...
                List.<ai.operativus.agentmanager.core.spi.RouteSelector>of(),
                null,
                null,
                null,
                null);
    ...
    void addWorkflowStep_conditionWithSkipPolicy_succeeds() {
        when(workflowRepository.existsByIdAndOrgId(eq("wf-1"), any())).thenReturn(true);
        when(workflowStepRepository.save(any(ai.operativus.agentmanager.core.entity.WorkflowStep.class)))
                .thenAnswer(inv -> inv.getArgument(0));
    ...
    void addWorkflowStep_elseBranchTargetCrossWorkflow_throws() {
        ...
        ai.operativus.agentmanager.core.entity.WorkflowStep otherStep =
                new ai.operativus.agentmanager.core.entity.WorkflowStep(
    ...
    void addWorkflowStep_elseBranchHappyPath_succeeds() {
        when(workflowRepository.existsByIdAndOrgId(eq("wf-1"), any())).thenReturn(true);
        ai.operativus.agentmanager.core.entity.WorkflowStep targetStep =
                new ai.operativus.agentmanager.core.entity.WorkflowStep(
    ...
    void continueAfterRouteSelection_nonAwaitingState_isSilentNoOp() {
        ...
        run.setOrgId(ai.operativus.agentmanager.core.model.TenantConstants.DEFAULT_SYSTEM_ORG);
    ...
    void continueAfterRouteSelection_invalidChoiceKey_throws() {
        ...
        ai.operativus.agentmanager.core.entity.WorkflowStep routerStep =
                new ai.operativus.agentmanager.core.entity.WorkflowStep(
