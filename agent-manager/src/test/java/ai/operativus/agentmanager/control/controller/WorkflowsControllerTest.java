...
class WorkflowsControllerTest {
    ...
    @Mock
    private ai.operativus.agentmanager.control.repository.WorkflowEdgeRepository workflowEdgeRepository;

    @Mock
    private ai.operativus.agentmanager.compute.workflow.WorkflowDagValidator dagValidator;

    @Mock
    private ai.operativus.agentmanager.control.repository.WorkflowNodeRunRepository workflowNodeRunRepository;

    @Mock
    private ai.operativus.agentmanager.control.repository.WorkflowNodeLayoutRepository workflowNodeLayoutRepository;
